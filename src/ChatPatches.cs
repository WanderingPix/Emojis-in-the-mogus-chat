...
namespace Emojis
{
    ...
    public class ChatPatches
    {
        ...
        public static void CreateButton()
        {
            ...
            Vector3 pos = chat.openKeyboardButton.transform.localPosition;
            pos.y += 2;
        ...
        [HarmonyPostfix]
        public static void OnFieldChangedPostfix(FreeChatInputField __instance)
        {
            if (OperatingSystem.IsAndroid()) return; //Android's keyboard might not work well with this patch, so I disabled it
            __instance.textArea.outputText.text = Utils.ReformatForEmojis(__instance.textArea.text);
        }
